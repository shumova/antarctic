...
window.addEventListener('DOMContentLoaded', function () {
  // Menu
  var elMainNav = document.querySelector('[data-menu]');
  var elMainNavList = document.querySelector('[data-menu-list]');
  var elMainNavToggle = document.querySelector('[data-menu-button]');
  var elBody = document.querySelector('body');

  if (elMainNav && elMainNavToggle && elMainNavList) {
    elMainNav.classList.remove('has-no-js');
    elMainNav.classList.add('is-closed');
    elMainNavToggle.addEventListener('click', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])(); // Booking form

    var elPhoneInput = document.querySelector('[data-phone]');
    var elNameInput = document.querySelector('[data-name]');

    if (elPhoneInput && elNameInput) {
      var validate = function validate(inputAttr) {
        var input = document.querySelector(inputAttr);
      ...
      elPhoneInput.addEventListener('keydown', function () {
        return validate('[data-phone]');
      });
